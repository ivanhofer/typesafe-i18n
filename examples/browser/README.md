...
Load your desired function from the unpkg CDN and inject it into your HTML-code:
  ...
  - [i18nObject](https://github.com/ivanhofer/typesafe-i18n#i18nObject) (1036 bytes gzipped)
  	```html
  ...
  - [i18n](https://github.com/ivanhofer/typesafe-i18n#i18n) (1066 bytes gzipped)
  ...
  - all together (1135 bytes gzipped)
  	```html
