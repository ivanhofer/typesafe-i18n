import { getConfigWithDefaultValues, readConfig } from '@typesafe-i18n/config/config.mjs'
import type { GeneratorConfig, GeneratorConfigWithDefaultValues } from '@typesafe-i18n/config/types.mjs'
