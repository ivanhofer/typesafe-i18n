...
const { component: TypesafeI18n, context: I18nContext, useContext: useI18nContext } = initI18nReact<Locales, Translations, TranslationFunctions, Formatters>(loadedLocales, loadedFormatters)
